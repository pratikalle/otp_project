<html>
    ...
    <div class="col-md-12">
		<div class="form_main">
            <h4 class="heading"><strong>Add User </strong> </h4>
            <div class="form">
                <form  id="register_form" name="register_form" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" placeholder="Please input your Name" value="" name="name" id="name"><br>
                    <label class="" style="margin-top:10px;">Email :</label>
                    <input type="email" placeholder="Please input your Email" value="" name="email" id="email"><br>
                    <label class="" style="margin-top:10px;">Mobile Number :</label>
                    <input type="number" placeholder="Please input your Number" value="" name="number" id="number"><br>
                    <label class="" style="margin-top:10px;">Address :</label>
                    <input type="text" placeholder="Please input your Address" value="" name="address" id="address"><br>
...
$(function(){
    ...
    $("form#register_form").submit(function(e){
        ...
        $.ajax({
            type:'post',
            dataType:'json',
            url:"http://localhost/codeigniter/register/submit_register_data", 
            data: data,
            processData: false,
            cache: false,
            contentType: false,
